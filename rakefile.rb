...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.AntiForgery"
COPYRIGHT = 'Copyright 2012 FubuMVC.AntiForgery. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.AntiForgery.sln', :clrversion => CLR_TOOLS_VERSION
